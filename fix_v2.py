...
def gerar_json_final():
        ...
        "nodes": [
            ...
            },
            {
                "parameters": {
                    ...
                    "options": {
                        "systemMessage": "=# IDENTIDADE\n- Você roteia agendamentos da Ellegance.\n\n# FUNÇÃO\n- Fernanda: faciais\n- Ângela: injetáveis/skincare\n- Kelly: corporais\n\n# REGRAS\n- Retorne datas no formato: \"terça-feira, dia 12/03, às 15h\".\n\n## CONTEXTO\n{{ $json.proximos_dias }}"
                    }
                },
            ...
            },
            {
                "parameters": {
                    "assignments": {
                        "assignments": [{"id": "resp1", "name": "response", "value": "={{ $json.output }}", "type": "string"}]
                    }
                },
                "id": "node_response_final",
                "name": "response",
                "type": "n8n-nodes-base.set",
                "typeVersion": 3.4,
                "position": [2300, 352]
    ...
    print("OK: Agente 4 reescrito com nó 'response' incluído!")
