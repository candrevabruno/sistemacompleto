...
import { Loader2, Check, Send, ClipboardList } from 'lucide-react';
...
export function ResumoConsultaSection({ pacienteId, leadId, nomePaciente }: Props) {
  ...
  const [historico, setHistorico] = useState<ResumoItem[]>([]);
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <textarea
            ...
            rows={6}
            style={{
              padding: '10px 12px', border: '1px solid var(--border-md)',
              borderRadius: '10px', fontSize: '12.5px', color: 'var(--ink)',
              fontFamily: 'inherit', resize: 'none', outline: 'none',
              background: 'var(--white)', lineHeight: 1.5,
            }}
          />
          <button
          ...
          >
            {salvando
              ...
              : webhookUrl ? <Send size={13} /> : <Check size={13} />
            }
