            ...
            <div className="overflow-x-auto rounded-[8px] border border-[var(--color-border-card)] mb-6">
              <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-[var(--color-border-card)] bg-white">
                  ...
                  <tr><td className="px-4 py-3 font-mono">procedimento_nome</td><td className="px-4 py-3 text-gray-500">String</td><td className="px-4 py-3 text-center"><Badge variant="default">NÃO</Badge></td><td className="px-4 py-3">Nome do serviço (texto livre)</td></tr>
